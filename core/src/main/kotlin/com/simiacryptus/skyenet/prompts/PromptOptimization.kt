...
class PromptOptimization {
    companion object {
        fun main() {
            // Run the test cases and gather the results
...
sealed class Expectation {
    class VectorMatch(val content: String) : Expectation() {
        override fun matches(prompt: String): Boolean {
            TODO("Not yet implemented")
        }

        override fun score(prompt: String): Double {
            TODO("Not yet implemented")
        }
    }
    ...
    abstract fun matches(prompt: String): Boolean

    abstract fun score(prompt: String): Double
